    ...
    >
      <div className="bg-white rounded-2xl w-full max-w-sm shadow-xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          <h2 className="font-bold text-gray-800 text-base">Nouveau produit</h2>
          <button
            onClick={onClose}
        ...
        <div className="px-5 py-4 space-y-4 max-h-[70vh] overflow-y-auto">
          ...
          <div>
            ...
            <button
              ...
              className="w-14 h-14 text-3xl flex items-center justify-center bg-gray-50 border-2 border-gray-200 rounded-xl hover:border-green-400 transition-colors"
            >
              {selectedEmoji}
            </button>
            {showPicker && (
              <div className="mt-2 max-h-44 overflow-y-auto bg-gray-50 rounded-xl p-3 space-y-3">
                {EMOJI_GRID.map(({ theme, emojis }) => (
                  <div key={theme}>
                    <p className="text-xs text-gray-400 uppercase font-semibold mb-1.5">{theme}</p>
